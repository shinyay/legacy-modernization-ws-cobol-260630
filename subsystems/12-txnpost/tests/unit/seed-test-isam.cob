       ...
       01  WS-STATUS-TABLE REDEFINES WS-STATUS-LIST.
           05  WS-STATUS OCCURS 3 TIMES PIC X(1).

       PROCEDURE DIVISION.
       MAIN-LOGIC.
           OPEN I-O ACCOUNT-FILE
           IF WS-FS NOT = "00"
               DISPLAY "[seed-test-isam] OPEN fail fs=" WS-FS
           ...
           PERFORM VARYING WS-IDX FROM 1 BY 1 UNTIL WS-IDX > 3
               ...
               MOVE WS-STATUS(WS-IDX) TO ACCT-REC-STATUS
           ...
           END-PERFORM
           CLOSE ACCOUNT-FILE
           DISPLAY "[seed-test-isam] inserted=" WS-INSERTED
           STOP RUN.

       END PROGRAM SEED-TEST-ISAM.
