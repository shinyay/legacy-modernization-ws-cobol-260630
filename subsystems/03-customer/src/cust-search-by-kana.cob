       ...
       PROGRAM-ID. CUST-SEARCH-BY-KANA.
       ...
       01  WS-CURRENT-KANA PIC X(50) VALUE SPACES.
       ...
       MAIN-LOGIC.
           ...
           IF CUST-IN-OP = "K"
               MOVE CUST-IN-KANA TO CR-KANA
               MOVE CUST-IN-KANA TO WS-CURRENT-KANA
               START CUSTOMER-FILE KEY >= CR-KANA
           ...
           READ CUSTOMER-FILE NEXT
               ...
               NOT AT END
                   IF CR-KANA(1:FUNCTION LENGTH(FUNCTION TRIM(WS-CURRENT-KANA)))
                      NOT = FUNCTION TRIM(WS-CURRENT-KANA)
                       MOVE 10 TO CUST-OUT-STATUS GOBACK
                   END-IF
