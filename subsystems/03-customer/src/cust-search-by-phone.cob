       ...
       PROGRAM-ID. CUST-SEARCH-BY-PHONE.
       ...
       01  WS-CURRENT-PHONE PIC X(15) VALUE SPACES.
       ...
       MAIN-LOGIC.
           ...
           IF CUST-IN-OP = "P"
               MOVE CUST-IN-PHONE TO CR-PHONE
               MOVE CUST-IN-PHONE TO WS-CURRENT-PHONE
               START CUSTOMER-FILE KEY = CR-PHONE
           ...
           READ CUSTOMER-FILE NEXT
               ...
               NOT AT END
                   IF CR-PHONE NOT = WS-CURRENT-PHONE
